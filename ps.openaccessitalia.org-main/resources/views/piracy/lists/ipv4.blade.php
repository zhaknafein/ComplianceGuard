        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">IPv4s</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <a target="_blank" href="/piracy/lists/ipv4/download/offline" class="btn btn-sm btn-primary font-weight-bold">
                            <i class="flaticon2-download"></i> Offline
                        </a>
                        <a target="_blank" href="/piracy/lists/ipv4/download/online" class="btn btn-sm btn-primary font-weight-bold ml-2">
